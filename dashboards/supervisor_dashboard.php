...
<head>
    ...
    <link rel="stylesheet" href="CSS/supervisor_dashboard_extra.css">
...
<body>
    ...
    <script type="application/json" id="supervisor-dashboard-data"><?= json_encode([
        'projects' => $projects,
        'invoices' => $invoices,
        'helpers' => $helpers,
        'overtime' => $overtime,
    ...
    <script src="JS/supervisor_bootstrap.js"></script>
